...
torch.save(AUC, "Result/step7_2_check-PT-F1/AUC")
torch.save([fpr, tpr, thresholds], "Result/step7_2_check-PT-F1/ROC")
torch.save(pred, "Result/step7_2_check-PT-F1/pred")
torch.save(t, "Result/step7_2_check-PT-F1/t")
