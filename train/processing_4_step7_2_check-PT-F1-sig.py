...
for s in tqdm(range(int(len(data_ft))), desc="Loop level A: each case", position=0, leave=False):
    ...
    filename = 'Result/step7_2_check-PT-F1-sig/'+str(s)
...
torch.save(AUC, "Result/step7_2_check-PT-F1-sig/AUC")
torch.save([fpr, tpr, thresholds], "Result/step7_2_check-PT-F1-sig/ROC")
torch.save(pred, "Result/step7_2_check-PT-F1-sig/pred")
torch.save(t, "Result/step7_2_check-PT-F1-sig/t")
